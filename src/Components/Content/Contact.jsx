    ...
    <div id='Contact' className='bg-white text-black dark:bg-slate-900 dark:text-white p-4 lg:p-20 flex flex-col items-center justify-center'>
      ...
      <form action="https://api.web3forms.com/submit" method="POST" className='flex flex-col gap-2 lg:w-1/2'>
        <div className=' dark:text-slate-500 lg:flex gap-6'>
          <input type="hidden" name="access_key" value="10f4b47a-cb09-44d1-9d49-8293d3e9e7d1" />
        ...
        <button
          className='nano-button my-3 shadow-xl hover:shadow-fuchsia-800/50 text-black dark:text-white  border-2 hover:bg-fuchsia-800 hover:border-yellow-500 rounded-lg py-4 px-8 uppercase relative overflow-hidden border-glow'
          type="submit"
        >
          Submit
        </button>
