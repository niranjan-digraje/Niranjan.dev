    ...
    <div id='Home' className=' bg-white text-black dark:bg-slate-900 dark:text-white lg:px-56 lg:py-0 px-10 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center'>
      <div className='h-full lg:py-40 flex flex-col justify-center lg:items-start items-center '>
        <h1 data-aos='fade-right' className='text-[52px] font-semibold mb-8 leading-normal uppercase'>
          Welcome To <span className='text-yellow-500'>My Portfolio Website</span>
        </h1>
        <p data-aos='fade-left'>
          Hi! , I am Niranjan , A passionate and detail-oriented final year B.Tech student pursuing a degree in Computer Science and Engineering.
          I am driven by a deep curiosity for emerging technologies and their transformative potential.
        </p>
          ...
          <div className='flex items-center justify-center'>
            ...
            <div className='flex space-x-2'>
              {social.map((social, index) => (
                <a key={index} target="_blank" href={social.link} className='text-yellow-500 hover:text-yellow-500 rounded-full glow p-2'>
